...
[​](#paginatedlistdatatable)[@vendure/dashboard](https://www.npmjs.com/package/@vendure/dashboard)[paginated-list-data-table.tsx](https://github.com/vendure-ecommerce/vendure/blob/master/packages/dashboard/src/lib/components/shared/paginated-list-data-table.tsx#L351)A wrapper around the DataTable component, which automatically configures functionality common to
